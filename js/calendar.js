...
_Calendar.ccy=n.getFullYear();
    ...
    s+="\n"+'<tr style="background:#29d9c2;font:12px Arial;color:#FFFFFF"><td align=center>M</td><td align=center>T</td><td align=center>W</td><td align=center>T</td><td align=center>F</td><td align=center>S</td><td align=center>S</td></tr>';
    ...
    s+='<tr><td colspan="7" align="center" style="cursor:pointer;font:13px Arial;background:#29d9c2" onclick="_Calendar.today()">Today: '+_Calendar.addnull(_Calendar.sccd,_Calendar.sccm+1,_Calendar.sccy)+'</td></tr>';
    tbl.innerHTML=s;
